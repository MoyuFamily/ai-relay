...
export const TRANSLATIONS = {
  zh: {
    ...
    setupKvReady: 'KV 已配置，请求日志与配置可持久化。',
    ...
    requestLogsDesc: '查看最近请求的 trace、模型、状态、延迟与脱敏诊断信息。',
    requestLogsDegraded: 'KV 不可用，当前展示内存降级日志，重启后会丢失。',
    logsAll: '全部状态',
    logsSuccess: '成功',
    logsError: '失败',
  ...
  en: {
    ...
    setupKvReady: 'KV is configured; logs and config can persist.',
    ...
    requestLogsTitle: '🧾 Request Logs',
    requestLogsDesc: 'Inspect recent request traces, models, status, latency, and redacted diagnostics.',
    requestLogsDegraded: 'KV unavailable; showing memory fallback logs that reset on restart.',
